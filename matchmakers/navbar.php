    ...
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <a href="view_all.php" class="nav-link px-2 link-secondary">
                <img src="matchmaker.png" alt="matchmaker" width=220 height=60>
            </a>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="add_client.php" class="nav-link px-2 mt-1 link-body-emphasis">Add New Client</a>
                </li>
                <li class="nav-item">
                    <a href="view_all.php" class="nav-link mt-1 px-2 link-body-emphasis">View Your Clients</a>
                </li>
                <li class="nav-item">
