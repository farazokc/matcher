...
<div class="container">
    <main>
        ...
        <div class="row">
            <div class="col-6 d-flex align-items-center justify-content-around" style="outline: 1px solid grey;">
                <div class="row">
                    <div class="text-center">
            ...
            <div class="col-6 text-center" style="outline: 1px solid grey;">
                <p class="fs-5"><strong>
                        Personal Details
                    </strong></p>
                <div class="d-flex">
            ...
            <div class="col-6 text-center mt-3" style="outline: 1px solid grey;">
                <div class="d-flex">
                    <div class="col-6">
                        <p class="fs-5"><strong>
                                Family Details
